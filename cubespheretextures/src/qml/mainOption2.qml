        ...
        Entity {
            ...
            components: [
                RenderSettings {
                    ...
                    activeFrameGraph: FrameGraphOption2 {
                        id: frameGraph
                        debugEnabled: debugSwitch.checked
                        camera: mainCamera
                        debugCamera: debugCam
                        cubeMapRenderTarget: cubeMapTarget
                    }
                },
            ...
            // Cube Renderer
            DynamicCubeMap {
                layer: frameGraph.firstPassLayer
                geometryRenderer: cubeSphere.cubeRenderer
                satelliteImagery: cubeSphere.satelliteImagery
                satelliteUniformBuffer: cubeSphere.satelliteUniformBuffer
                elevationUniformBuffer: cubeSphere.elevationUniformBuffer
                elevation: cubeSphere.elevation
            }
            ...
            // Sphere Rendering
            Entity {
                readonly property Material material: CubeSphereMaterialOption2 {
                    ...
                    satelliteCubeMap: cubeMapTarget.satelliteCubeMap
                    elevationCubeMap: cubeMapTarget.elevationCubeMap
                }
        ...
        RowLayout {
            GroupBox {
                ...
                RowLayout {
                    ...
                    Switch { id: debugSwitch; text: "Debug"; checked: false}
