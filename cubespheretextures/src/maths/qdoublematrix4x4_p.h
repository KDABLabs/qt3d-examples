...
public:
    ...
    friend QDoubleMatrix4x4 operator/(const QDoubleMatrix4x4& matrix, double divisor);
    ...
    friend QDebug operator<<(QDebug dbg, const QDoubleMatrix4x4 &m);
#endif
...
QDataStream &operator<<(QDataStream &, const QDoubleMatrix4x4 &);
QDataStream &operator>>(QDataStream &, QDoubleMatrix4x4 &);
#endif
